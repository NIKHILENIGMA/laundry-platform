...
A shared component library for the laundry platform built with [shadcn/ui](https://ui.shadcn.com/).

## Overview

This library provides a collection of reusable UI components based on shadcn/ui, ensuring consistency and maintainability across the laundry platform applications.
...
```bash
npm install @laundry-platform/ui
```
